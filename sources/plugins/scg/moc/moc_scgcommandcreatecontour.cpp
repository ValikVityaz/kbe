...
struct qt_meta_stringdata_SCgCommandCreateContour_t {
    QByteArrayData data[3];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgCommandCreateContour_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgCommandCreateContour_t qt_meta_stringdata_SCgCommandCreateContour = {
    {
QT_MOC_LITERAL(0, 0, 23), // "SCgCommandCreateContour"
QT_MOC_LITERAL(1, 24, 16), // "contourDestroyed"
QT_MOC_LITERAL(2, 41, 0) // ""

    },
    "SCgCommandCreateContour\0contourDestroyed\0"
    ""
};
...
QT_INIT_METAOBJECT const QMetaObject SCgCommandCreateContour::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_SCgCommandCreateContour.data,
    qt_meta_data_SCgCommandCreateContour,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgCommandCreateContour::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgCommandCreateContour.stringdata0))
