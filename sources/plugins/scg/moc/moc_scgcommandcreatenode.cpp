...
struct qt_meta_stringdata_SCgCommandCreateNode_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgCommandCreateNode_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgCommandCreateNode_t qt_meta_stringdata_SCgCommandCreateNode = {
    {
QT_MOC_LITERAL(0, 0, 20), // "SCgCommandCreateNode"
QT_MOC_LITERAL(1, 21, 13), // "nodeDestroyed"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "SCgCommandCreateNode\0nodeDestroyed\0"
};
...
QT_INIT_METAOBJECT const QMetaObject SCgCommandCreateNode::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_SCgCommandCreateNode.data,
    qt_meta_data_SCgCommandCreateNode,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgCommandCreateNode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgCommandCreateNode.stringdata0))
