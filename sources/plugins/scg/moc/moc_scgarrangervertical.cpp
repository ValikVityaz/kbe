...
struct qt_meta_stringdata_SCgVerticalArranger_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgVerticalArranger_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgVerticalArranger_t qt_meta_stringdata_SCgVerticalArranger = {
    {
QT_MOC_LITERAL(0, 0, 19) // "SCgVerticalArranger"
...
static const uint qt_meta_data_SCgVerticalArranger[] = {
...
QT_INIT_METAOBJECT const QMetaObject SCgVerticalArranger::staticMetaObject = { {
    &SCgArranger::staticMetaObject,
    qt_meta_stringdata_SCgVerticalArranger.data,
    qt_meta_data_SCgVerticalArranger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgVerticalArranger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgVerticalArranger.stringdata0))
