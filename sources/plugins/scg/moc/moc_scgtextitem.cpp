...
struct qt_meta_stringdata_SCgTextItem_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgTextItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgTextItem_t qt_meta_stringdata_SCgTextItem = {
    {
QT_MOC_LITERAL(0, 0, 11) // "SCgTextItem"
...
static const uint qt_meta_data_SCgTextItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject SCgTextItem::staticMetaObject = { {
    &QGraphicsTextItem::staticMetaObject,
    qt_meta_stringdata_SCgTextItem.data,
    qt_meta_data_SCgTextItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgTextItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgTextItem.stringdata0))
