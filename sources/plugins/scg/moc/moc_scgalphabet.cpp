...
struct qt_meta_stringdata_SCgAlphabet_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgAlphabet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgAlphabet_t qt_meta_stringdata_SCgAlphabet = {
    {
QT_MOC_LITERAL(0, 0, 11) // "SCgAlphabet"
...
QT_INIT_METAOBJECT const QMetaObject SCgAlphabet::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_SCgAlphabet.data,
    qt_meta_data_SCgAlphabet,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgAlphabet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgAlphabet.stringdata0))
