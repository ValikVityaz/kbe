...
struct qt_meta_stringdata_SCgSelectInputOutput_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgSelectInputOutput_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgSelectInputOutput_t qt_meta_stringdata_SCgSelectInputOutput = {
    {
QT_MOC_LITERAL(0, 0, 20) // "SCgSelectInputOutput"
...
QT_INIT_METAOBJECT const QMetaObject SCgSelectInputOutput::staticMetaObject = { {
    &SCgSelect::staticMetaObject,
    qt_meta_stringdata_SCgSelectInputOutput.data,
    qt_meta_data_SCgSelectInputOutput,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgSelectInputOutput::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgSelectInputOutput.stringdata0))
