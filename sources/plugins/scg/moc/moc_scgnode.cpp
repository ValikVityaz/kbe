...
struct qt_meta_stringdata_SCgNode_t {
    QByteArrayData data[3];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgNode_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgNode_t qt_meta_stringdata_SCgNode = {
    {
QT_MOC_LITERAL(0, 0, 7), // "SCgNode"
QT_MOC_LITERAL(1, 8, 14), // "contentChanged"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "SCgNode\0contentChanged\0"
};
...
void SCgNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SCgNode::contentChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SCgNode::staticMetaObject = { {
    &SCgObject::staticMetaObject,
    qt_meta_stringdata_SCgNode.data,
    qt_meta_data_SCgNode,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgNode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgNode.stringdata0))
