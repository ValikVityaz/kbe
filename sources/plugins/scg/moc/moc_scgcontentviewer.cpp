...
struct qt_meta_stringdata_SCgContentViewer_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgContentViewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgContentViewer_t qt_meta_stringdata_SCgContentViewer = {
    {
QT_MOC_LITERAL(0, 0, 16) // "SCgContentViewer"
...
QT_INIT_METAOBJECT const QMetaObject SCgContentViewer::staticMetaObject = { {
    &QGraphicsProxyWidget::staticMetaObject,
    qt_meta_stringdata_SCgContentViewer.data,
    qt_meta_data_SCgContentViewer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgContentViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgContentViewer.stringdata0))
