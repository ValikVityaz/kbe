...
struct qt_meta_stringdata_SCgScene_t {
    QByteArrayData data[6];
    char stringdata0[74];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgScene_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgScene_t qt_meta_stringdata_SCgScene = {
    {
QT_MOC_LITERAL(0, 0, 8), // "SCgScene"
QT_MOC_LITERAL(1, 9, 15), // "editModeChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "mode"
QT_MOC_LITERAL(4, 31, 16), // "setIdtfDirtyFlag"
QT_MOC_LITERAL(5, 48, 25) // "ensureSelectedItemVisible"

    },
    "SCgScene\0editModeChanged\0\0mode\0"
    "setIdtfDirtyFlag\0ensureSelectedItemVisible"
};
...
void SCgScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SCgScene::editModeChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SCgScene::staticMetaObject = { {
    &QGraphicsScene::staticMetaObject,
    qt_meta_stringdata_SCgScene.data,
    qt_meta_data_SCgScene,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgScene.stringdata0))
