...
struct qt_meta_stringdata_SCgBusMode_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgBusMode_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgBusMode_t qt_meta_stringdata_SCgBusMode = {
    {
QT_MOC_LITERAL(0, 0, 10) // "SCgBusMode"
...
QT_INIT_METAOBJECT const QMetaObject SCgBusMode::staticMetaObject = { {
    &SCgMode::staticMetaObject,
    qt_meta_stringdata_SCgBusMode.data,
    qt_meta_data_SCgBusMode,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgBusMode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgBusMode.stringdata0))
