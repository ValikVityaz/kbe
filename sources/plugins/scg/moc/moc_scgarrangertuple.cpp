...
struct qt_meta_stringdata_SCgTupleArranger_t {
    QByteArrayData data[6];
    char stringdata0[71];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgTupleArranger_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgTupleArranger_t qt_meta_stringdata_SCgTupleArranger = {
    {
QT_MOC_LITERAL(0, 0, 16), // "SCgTupleArranger"
QT_MOC_LITERAL(1, 17, 13), // "xValueChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "newSpacing"
QT_MOC_LITERAL(4, 43, 13), // "yValueChanged"
QT_MOC_LITERAL(5, 57, 13) // "dValueChanged"

    },
    "SCgTupleArranger\0xValueChanged\0\0"
    "newSpacing\0yValueChanged\0dValueChanged"
};
...
void SCgTupleArranger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SCgTupleArranger *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SCgTupleArranger::staticMetaObject = { {
    &SCgArranger::staticMetaObject,
    qt_meta_stringdata_SCgTupleArranger.data,
    qt_meta_data_SCgTupleArranger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgTupleArranger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgTupleArranger.stringdata0))
