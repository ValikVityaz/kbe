...
struct qt_meta_stringdata_SCgNodeTextItem_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgNodeTextItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgNodeTextItem_t qt_meta_stringdata_SCgNodeTextItem = {
    {
QT_MOC_LITERAL(0, 0, 15) // "SCgNodeTextItem"
...
QT_INIT_METAOBJECT const QMetaObject SCgNodeTextItem::staticMetaObject = { {
    &SCgTextItem::staticMetaObject,
    qt_meta_stringdata_SCgNodeTextItem.data,
    qt_meta_data_SCgNodeTextItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgNodeTextItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgNodeTextItem.stringdata0))
