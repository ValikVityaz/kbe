...
struct qt_meta_stringdata_SCgHorizontalArranger_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgHorizontalArranger_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgHorizontalArranger_t qt_meta_stringdata_SCgHorizontalArranger = {
    {
QT_MOC_LITERAL(0, 0, 21) // "SCgHorizontalArranger"
...
static const uint qt_meta_data_SCgHorizontalArranger[] = {
...
QT_INIT_METAOBJECT const QMetaObject SCgHorizontalArranger::staticMetaObject = { {
    &SCgArranger::staticMetaObject,
    qt_meta_stringdata_SCgHorizontalArranger.data,
    qt_meta_data_SCgHorizontalArranger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgHorizontalArranger::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgHorizontalArranger.stringdata0))
