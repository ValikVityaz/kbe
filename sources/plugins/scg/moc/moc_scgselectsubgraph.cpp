...
struct qt_meta_stringdata_SCgSelectSubGraph_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SCgSelectSubGraph_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SCgSelectSubGraph_t qt_meta_stringdata_SCgSelectSubGraph = {
    {
QT_MOC_LITERAL(0, 0, 17) // "SCgSelectSubGraph"
...
QT_INIT_METAOBJECT const QMetaObject SCgSelectSubGraph::staticMetaObject = { {
    &SCgSelect::staticMetaObject,
    qt_meta_stringdata_SCgSelectSubGraph.data,
    qt_meta_data_SCgSelectSubGraph,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SCgSelectSubGraph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCgSelectSubGraph.stringdata0))
